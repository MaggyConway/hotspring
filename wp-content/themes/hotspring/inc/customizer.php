...
function themes_starter_customize( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => __( 'Header', 'hotspring-lang' ),
			'priority' => 1000,
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'hotspring-lang' ),
				'description' => __( 'Height: &gt;80px', 'hotspring-lang' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar Scheme', 'hotspring-lang' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'navbar-light bg-light'  => __( 'Default', 'hotspring-lang' ),
				'navbar-dark bg-dark'    => __( 'Dark', 'hotspring-lang' ),
				'navbar-dark bg-primary' => __( 'Primary', 'hotspring-lang' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar', 'hotspring-lang' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'static'       => __( 'Static', 'hotspring-lang' ),
				'fixed_top'    => __( 'Fixed to top', 'hotspring-lang' ),
				'fixed_bottom' => __( 'Fixed to bottom', 'hotspring-lang' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Show Searchfield?', 'hotspring-lang' ),
			'section'  => 'theme_header_section',
