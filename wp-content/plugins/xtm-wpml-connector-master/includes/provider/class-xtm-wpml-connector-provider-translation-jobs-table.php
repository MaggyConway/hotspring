...
/**
 * Class XTM_Translation_Jobs_Table
 */
class XTM_Translation_Jobs_Table
{
    /**
     ...
     * @var array
     */
    private $translation_filter = ['limit_no' => 1000, 'translator_id' => ''];

    /**
     * XTM_Translation_Jobs_Table constructor.
     * @param $iclTranslationManagement
     */
