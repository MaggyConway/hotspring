...
/**
 * Elementor Hero Blog Article
 *
 * Elementor widget for Hero Blog Article.
 *
 * @since 1.0.0
 */
class Hero_Blog_Article extends Widget_Base {
	...
	public function get_title() {
		return __( 'Hero Blog Article', 'hotspring-lang' );
	}
