...
/**
 * Elementor Hero Default Gallery
 *
 * Elementor widget for Hero Default Gallery.
 *
 * @since 1.0.0
 */
class Hero_Default_Gallery extends Widget_Base {
	...
	public function get_title() {
		return __( 'Hero Default Gallery', 'hotspring-lang' );
	}
	...
	protected function render() {
		...
		echo '<h2>Hero Default Gallery</h2>';
		echo $settings['title'];
		echo '</div>';
	}
