...
/**
 * Elementor Section_Copy
 *
 * Elementor widget for Section_Copy.
 *
 * @since 1.0.0
 */
class Section_Copy extends Widget_Base {
	...
	public function get_title() {
		return __( 'Section Copy', 'hotspring-lang' );
	}
