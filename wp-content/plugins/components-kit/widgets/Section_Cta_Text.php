 ...
 * @since 1.0.0
 */
class Section_Cta_Text extends Widget_Base {
    ...
    public function get_title() {
        return __( 'CTA Text', 'hotspring-lang' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .cta-text' => 'text-transform: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        ?>
        <div class="row">
            <div class="col-xl-6 offset-xl-3 text-center cta-text">
