...
/**
 * Elementor Two_Cards_Carousel
 *
 * Elementor widget for Tow_Cards_Carousel.
 *
 * @since 1.0.0
 */
class Two_Cards_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Two Cards', 'hotspring-lang' );
	}
