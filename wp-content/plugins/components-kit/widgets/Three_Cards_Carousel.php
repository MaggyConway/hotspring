...
/**
 * Elementor Three Cards Carousel
 *
 * Elementor widget for Three Card.
 *
 * @since 1.0.0
 */
class Three_Cards_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Three Cards Carousel', 'hotspring-lang' );
	}
	...
	protected function render() {
		...
		echo '<h2>Three Cards Carousel</h2>';
		echo $settings['title'];
		echo '</div>';
	}
