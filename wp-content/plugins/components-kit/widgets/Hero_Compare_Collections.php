...
/**
 * Elementor Hero Compare Collections
 *
 * Elementor widget for Hero Compare Collections.
 *
 * @since 1.0.0
 */
class Hero_Compare_Collections extends Widget_Base {
	...
	public function get_name() {
		return 'hero-compare-collections';
	}
	...
	public function get_title() {
		return __( 'Hero Compare Collections', 'hotspring-lang' );
	}
	...
	protected function render() {
		...
		echo '<h2>Hero Compare Collections</h2>';
		echo $settings['title'];
		echo '</div>';
	}
	...
	protected function content_template() {
		?>
		<div class="title">
			<h2>Hero Compare Collections</h2>
			{{{ settings.title }}}
		</div>
		<?php
	}
