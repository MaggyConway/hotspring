...
/**
 * Elementor Hero Blog Home
 *
 * Elementor widget for Hero Blog Home.
 *
 * @since 1.0.0
 */
class Hero_Blog_Home extends Widget_Base {
	...
	public function get_title() {
		return __( 'Hero Blog Home', 'hotspring-lang' );
	}
