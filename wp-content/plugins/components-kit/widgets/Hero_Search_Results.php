...
/**
 * Elementor Hero Search Results
 *
 * Elementor widget for Hero Search Results.
 *
 * @since 1.0.0
 */
class Hero_Search_Results extends Widget_Base {
	...
	public function get_title() {
		return __( 'Hero Search Results', 'hotspring-lang' );
	}
	...
	protected function render() {
		...
		echo '<h2>Hero Search Results</h2>';
		echo $settings['title'];
		echo '</div>';
	}
